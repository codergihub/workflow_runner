...
async function updateTaskLog({ workflow, workflows }) {
    ...
    await fbDatabase.ref("/").update({ ...updateTaskTotal, ...updateTaskStart, ...updateTaskFailed, ...updateTaskSuccess, ...updateTaskLastLogTotal, ...updateTaskLastLogStart, ...updateTaskLastLogFailed, ...updateTaskLastLogSuccess })
}
